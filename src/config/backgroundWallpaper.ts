...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		desktop: [
			"assets/images/DesktopWallpaper/EVA1.avif",
			"assets/images/DesktopWallpaper/EVA2.avif",
			"assets/images/DesktopWallpaper/EVA3.avif",
			"assets/images/DesktopWallpaper/EVA4.avif",
		],
		// 移动背景图片（支持单张或多张随机）
		// mobile: "assets/images/MobileWallpaper/m1.avif",
		mobile: [
			"assets/images/MobileWallpaper/Asuka1.avif",
			"assets/images/MobileWallpaper/Asuka2.avif",
			"assets/images/MobileWallpaper/Asuka3.avif",
			"assets/images/MobileWallpaper/Asuka4.avif",
		],
		// 背景视频播放地址
	...
	common: {
		...
		homeText: {
			...
			// 主页横幅副标题
			subtitle: [
				"In Yellow Wood, Two Paths Diverged",
				"By One Traveler, Long They Were Regarded",
				"Both Untrodden, Both Equally Lay",
				"Yet One Was Chosen, the Less Worn Way",
				"Knowing Roads Lead on to Roads, I Couldn't Stay",
				"And That Choice Made All the Difference That Day",
			],
			// 主页横幅副标题字体大小
			subtitleSize: "1.5rem",
			typewriter: {
